...
@section('horizontal_sidebar')
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm rounded-bottom px-3 py-2 custom-dark-green-bg navbar-compact">
...
.navbar.navbar-compact {
    ...
    padding-top: 0.3rem !important; /* Adjust this value */
...
.navbar.navbar-compact .navbar-nav .nav-link {
    ...
    padding-top: 0.2rem !important; /* Adjust this value */
    padding-bottom: 0.2rem !important; /* Adjust this value */

    /* Make the text slightly smaller */
    font-size: 0.85rem !important; /* Adjust this value, e.g., 0.8rem for even smaller */
}

.navbar.navbar-compact .navbar-nav .nav-link .material-icons {
    /* Make the Material Icons smaller */
    font-size: 18px !important; /* Default is often 24px, 18px is a good reduction */
    margin-right: 0.3rem !important; /* Adjust margin next to icon if needed */
}
                ...
                <div class="card shadow-sm border-0 rounded-3 p-4">
                    ...
                    <form method="POST" action="{{ route('grn.store') }}" id="salesEntryForm">
                        ...
                        <div class="row g-1 form-row align-items-start mt-1">
                            <div class="col-md-3" style="margin-bottom: 2px; max-width: 90px;">
                                ...
                                <input type="text" name="customer_code" id="new_customer_code"
                                    ...
                                    style="height: 24px; font-size: 11px; padding: 2px 6px; width: 100%;" required>
                                @error('customer_code')
                                ...
                                @foreach ($salesNotPrinted as $customerCode => $salesForCustomer)
                                    ...
                                    <li data-customer-code="{{ $customerCode }}">
                                        <div class="customer-header bill-clickable" data-customer-code="{{ $customerCode }}"
                                            ...
                                            <span style="flex: 1;">
                                                ({{ strtoupper($customerCode) }}) - Rs.{{ number_format($totalCustomerSalesAmount, 2) }}
                                            </span>
                ...
                $(document).ready(function () {
                    ...
                    $('#grn_select').select2({
                        ...
                        templateSelection: function (data) {
                            ...
                            $selection.addClass('select2-black-text'); // <--- ADD THIS LINE
