...
<div class="container mt-4">
       ...
       <div class="row g-3 mb-3">
           ...
           <div class="row g-2 mb-3 align-items-end mt-2">
               ...
               <div class="col-md-2">
                   ...
                   <input type="number" id="nc_perkg_price" name="per_kg_price" class="form-control form-control-sm" step="0.01">
               </div>
   ...
   <table class="table table-bordered table-striped" id="grn_table" style="display:none;">
       <thead class="table-dark">
           <tr>
               <th>ID</th><th>Code</th><th>Supplier Code</th><th>Item Code</th>
               <th>Item Name</th><th>Packs</th><th>Weight (kg)</th><th>Per KG Price</th>
               <th>Txn Date</th><th>GRN No</th><th>Action</th>
           </tr>
       </thead>
